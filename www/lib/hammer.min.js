...
(function(t) {
    ...
    function e() {
        if (!n.READY) {
            ...
            for (var t in n.gestures)
                n.gestures.hasOwnProperty(t) && n.detection.register(n.gestures[t]);
    ...
    n.event = {
        ...
        extendEventData: function(t) {
            ...
            if (e && (t.touches.length != e.touches.length || t.touches === e.touches)) {
                ...
                for (var i = 0, r = t.touches.length; r > i; i++)
                    e.touches.push(n.utils.extend({}, t.touches[i]))
            }
        ...
        handler: function(t, e) {
            if (n.detection.current.name != this.name && this.triggered)
                return e.trigger(this.name + "end", t), this.triggered=!1, void 0;
        ...
        handler: function(t, e) {
            ...
            if (!(2 > t.touches.length))
                switch (e.options.transform_always_block && t.preventDefault(), t.eventType) {
                case n.EVENT_START:
                    this.triggered=!1;
                    break;
                case n.EVENT_MOVE:
                    var i = Math.abs(1 - t.scale), r = Math.abs(t.rotation);
                    if (e.options.transform_min_scale > i && e.options.transform_min_rotation > r)
                        return;
    ...
    "use strict";
    t && (Hammer.event.bindDom = function(e, n, i) {
        t(e).on(n, function(t) {
            var e = t.originalEvent;
            e.pageX || (e.pageX = t.pageX, e.pageY = t.pageY), e.target || (e.target = t.target), e.which || (e.which = e.button), e.preventDefault || (e.preventDefault = t.preventDefault), e.stopPropagation || (e.stopPropagation = t.stopPropagation), i.call(this, e)
        })
        ...
        return t(n.srcEvent.target).trigger({
            type: e,
            gesture: n
        })
        ...
        return this.each(function() {
            ...
            i ? i && e && Hammer.utils.extend(i.options, e) : n.data("hammer", Hammer(this, e || {}))
        })
    })
}(window.jQuery ||!1);
